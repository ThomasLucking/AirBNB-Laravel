        ...
        <form method="POST" action="/store" class="w-full max-w-sm mx-auto">
            ...
            <div class="flex flex-col gap-4 mt-6">
                <div class="flex flex-col gap-1">
                    <label class="text-left text-xs font-bold uppercase tracking-wider text-gray-600">Full Name</label>
                    <input name="name"
                ...
                <div class="flex flex-col gap-1">
                    <label class="text-left text-xs font-bold uppercase tracking-wider text-gray-600"> Create
                        Password</label>
                    <input name="password"
                        class="text-base border-2 border-gray-200 rounded-lg px-3 py-2 outline-none focus:border-red-500 transition-colors"
