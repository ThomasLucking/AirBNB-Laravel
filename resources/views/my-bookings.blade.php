        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="max-w-sm m-8">
                    <article class="overflow-hidden rounded-lg border border-gray-800 bg-white shadow-xs">
                        ...
                        <div class="p-2.5 sm:p-4">
                            ...
                            <p class="mt-2 line-clamp-3 text-sm/relaxed text-gray-500">{{ $booking->apartment->description }}</p>

                            <div class="space-y-2 mt-3">
                                <p class="font-bold text-black italic">Total: ${{ $booking->total }}</p>
                            </div>

                            <a href="{{ route('apartment.show', $booking->apartment) }}" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-[#FF645C]">
                                View Apartment
            ...
            @empty
                <div class="col-span-full text-center py-8">
                    ...
                    <a href="{{ route('home') }}" class="mt-4 inline-block text-[#FF645C] font-medium hover:underline">Browse apartments</a>
                </div>
            @endforelse
        </div>
