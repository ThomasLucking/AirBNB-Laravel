    ...
    <div class="flex items-center justify-center p-4">
        @auth
            ...
            <div id="filterDropdown"
                class="z-10 hidden w-56 bg-white divide-y divide-gray-100 rounded-lg shadow-xl dark:bg-gray-700 dark:divide-gray-600">
                <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200">
                    <li>
                        <label class="flex items-center cursor-pointer group">
                            ...
                            <span class="ms-3 font-medium group-hover:text-indigo-600 transition-colors">My
                                Apartments</span>
                        </label>
                    </li>
                    <li>
